...
public class Video extends Publicacion {
    ...
    public Video(String nombre, String fechaSubida, String etiquetasHashtags, String comentarios, int cantidadMG, float duracion, float resolucion, int cantidadDeCuadros) {
